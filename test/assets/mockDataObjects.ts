...
function initializeParentData() {
  ...
  let data7 = User.findOne({csid: 'c3c1', fname: 'Agent'})
    .exec()
    .then(c => {
      return USER_5_AGENT = c;
    });
  let data8 = User.findOne({csid: 'a1a1', fname: 'Connor'})
    .exec()
    .then(c => {
      return USER_4_CONNOR = c;
    });
  let data9 = User.findOne({csid: 'b2b1', fname: 'Roger'})
    .exec()
    .then(c => {
      return USER_6_ROGER = c;
    });
  let data10 = User.findOne({csid: 'e5e5', fname: 'Regis'})
    .exec()
    .then(c => {
      return USER_3_REGIS = c;
    });
  let data11 = User.create({
    csid:     faker.random.number(999999999), snum: faker.random.number(9999999),
    fname:    faker.name.firstName(), lname: faker.name.lastName(), courses: new Array(),
    username: faker.internet.userName()
  })
    .then(c => {
      c.save();
      return RANDOM_STUDENT_1 = c;
    });
  let data12 = User.create({
    csid:     faker.random.number(999999999), snum: faker.random.number(9999999),
    fname:    faker.name.firstName(), lname: faker.name.lastName(), courses: new Array(),
    username: faker.internet.userName()
  })
    .then(c => {
      c.save();
      return RANDOM_STUDENT_2 = c;
    });
  let data13 = User.create({
    csid:     faker.random.number(999999999), snum: faker.random.number(9999999),
    fname:    faker.name.firstName(), lname: faker.name.lastName(), courses: new Array(),
    username: faker.internet.userName()
  })
    .then(c => {
      c.save();
      return RANDOM_STUDENT_3 = c;
    });
  let data14 = User.create({
    csid:     faker.random.number(999999999), snum: faker.random.number(9999999),
    fname:    faker.name.firstName(), lname: faker.name.lastName(), courses: new Array(),
    username: faker.internet.userName()
  })
    .then(c => {
      c.save();
      return RANDOM_STUDENT_4 = c;
    });
  let data15 = User.create({
    csid:     faker.random.number(999999999), snum: faker.random.number(9999999),
    fname:    faker.name.firstName(), lname: faker.name.lastName(), courses: new Array(),
    username: faker.internet.userName()
  })
  ...
  let data16 = Deliverable.findOne({name: 'Assignment 1'})
    ...
    .then(d => {
      return Team.findOrCreate({
        ...
        .then(t => {
          console.log('got into the return' + t);
          return TEAM_COMPUTATIONAL_THEORY = t;
        })
...
export {
  initializeData, USER_1_THOMAS, USER_2_CYNTHIA, USER_3_REGIS, USER_4_CONNOR,
